...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    label.text = [NSString stringWithFormat:@"Product:%@ \n MyClass:%@ \n MySubclass:%@", [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleDisplayName"], [myClass myString], [mySubclass myString]];
